                                ...
                                <div class="header mb--40 text-center">
                                    ...
                                    <div class="post-meta mt--20">
                                        ...
                                        <div class="post-category">
                                            <nuxt-link v-for="(category, i) in data.categories" :key="i" :to="`/blog/category/${slugify(category)}`" class="mr-2">{{ category }},</nuxt-link>
                                        </div>
                                    </div>
                                </div>
                                <!-- Start Thumbnail -->
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-12">
                                            <div class="post-tag d-flex align-items-center">
                                                ...
                                                <div class="blog-tag-list pl--5">
                                                    <nuxt-link to="/blog/blog-creative">business</nuxt-link>
