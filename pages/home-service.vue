    ...
    <div class="main-container">
                        ...
                        <div class="home-service-inner">
                            <div class="content">
                                ...
                                <div class="home-service-btn mt--60 wow move-up">
                                    <nuxt-link to="" class="brook-btn bk-btn-theme btn-sd-size btn-rounded space-between">Shop Collection</nuxt-link>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="home-service-progress bg_color--1 pt--180 pt_sm--80 pt_md--80 space_dec--100 space_dec--none">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="progress-thumbnail wow move-up text-lg-start text-center">
                        ...
                        <div class="service-progress-inner">
                            ...
                            <div class="row mt--120 mt_md--40 mt_sm--40">
                                ...
                                <div class="col-lg-6 col-sm-6 wow move-up">
                                    <div class="brook-counter text-start">
                                        <div class="icon">
