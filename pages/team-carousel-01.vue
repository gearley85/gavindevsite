                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="brook-element-carousel">
                            ...
                            >
                                <swiper-slide v-for="teamMember in data.teamMembers.slice(7, 10)" :key="teamMember.id">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="call-content vertical-call-toaction text-center">
                            ...
                            <div class="call-btn text-center">
                                <nuxt-link to="/contact-us-modern" class="brook-btn bk-btn-theme text-theme btn-sd-size btn-rounded">Find out more</nuxt-link>
                            </div>
                        </div>
                    </div>
                </div>
